  ...
  return (
    ...
    <div className="w-64 bg-gray-900 text-white flex flex-col h-screen border-r border-gray-800 shrink-0">
      ...
      <div className="p-6 flex items-center gap-3 border-b border-gray-800">
        ...
        <h1 className="text-xl font-bold tracking-wider">CyberQuest</h1>
      </div>
      ...
      <nav className="flex-1 p-4 space-y-2 overflow-y-auto">
        ...
        <Link
          to="/dashboard"
          className={`flex items-center gap-3 px-4 py-3 rounded-lg transition-colors ${isActive('/dashboard') ? 'bg-blue-600 text-white shadow-md' : 'text-gray-400 hover:bg-gray-800 hover:text-white'}`}
        >
        ...
        <Link
          to="/vaultid"
          className={`flex items-center gap-3 px-4 py-3 rounded-lg transition-colors ${isActive('/vaultid') ? 'bg-blue-600 text-white shadow-md' : 'text-gray-400 hover:bg-gray-800 hover:text-white'}`}
        >
          <Search size={20} />
          <span>Intel Scanner</span>
        </Link>
        ...
        <Link
          to="/ai-detector"
          className={`flex items-center gap-3 px-4 py-3 rounded-lg transition-colors ${isActive('/ai-detector') ? 'bg-blue-600 text-white shadow-md' : 'text-gray-400 hover:bg-gray-800 hover:text-white'}`}
        >
          <Shield size={20} />
