...
import { ShieldAlert, Terminal, Eye, Code2, Globe, Cpu, Lock, Trophy, ArrowRight, ChevronRight, Zap, Shield } from 'lucide-react';
...
const FEATURES = [
  ...
  { icon: Shield, color: '#a855f7', title: 'AI Detector', desc: 'Real-time machine learning Intrusion Detection System that spots malicious network traffic.' },
